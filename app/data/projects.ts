...
export const projectData: Project[] = [
  ...
  //   link: 'https://www.japhethjerry.space',
  ...
  // },
    ...
    brief: 'An enterprise-grade CLI and web platform offering a 150+ point pre-launch checklist. It combines deterministic AST parsing with AI-driven reviews to catch silent failures, broken fallbacks, and security vulnerabilities.',
    about: 'Periderm CLI represents a leap in developer tools, merging static code analysis with large language models. It scans complex codebases to provide actionable, senior-engineer-level insights, bridging the gap between raw AST data and real-world application stability.',
    description: 'Architected and developed Periderm, a comprehensive SaaS platform and CLI tool designed to safeguard fast-moving codebases before production deployment. The CLI leverages Babel\'s AST engine to perform 150+ deterministic checks across routing, authentication, legal compliance, and performance metrics. It seamlessly integrates with a full-stack dashboard powered by Vite, React, TanStack Router, and Supabase, allowing teams to track scan histories, enforce cloud-level policies, and manage project health. Beyond static analysis, I engineered an AI deep-review agent utilizing Groq\'s ultra-fast inference to contextualize vulnerabilities, offering developers actionable remediation strategies rather than generic warnings. The platform supports local watch modes, CI/CD pipeline integration, and robust cross-platform reporting. This project highlights my ability to conceptualize, build, and scale sophisticated, developer-focused tooling with seamless terminal-to-web synchronization.',
    status: 'Completed',
    isPersonal: true
  },
  {
  ...
  },
  {
    ...
    brief: "A comprehensive digital platform supporting donation processing, scholarship applications, and impact tracking to empower the foundation's operations.",
  ...
  },
  {
    ...
    "image": "./assets/images/project-57.avif",
    "link": "https://weblaunchguys.vercel.app/",
  ...
  },
  {
    ...
    image: './assets/images/project-47.avif',
    link: './assets/images/project-47.avif',
  ...
  },
  {
    ...
    tools: 'Figma',
    image: './assets/images/project-16.avif',
    ...
    brief: 'A comprehensive and well-prototyped dashboard design for computer-aided instruction studies. Created in Figma, focusing on user experience and intuitive navigation.',
  ...
  },
  {
    ...
    tools: 'Adobe Photoshop',
    image: './assets/images/project-27.avif',
    link: './assets/images/project-27.avif',
  ...
  },
  {
    ...
    tools: 'CorelDRAW',
    image: './assets/images/project-36.avif',
    link: './assets/images/project-36.avif',
  ...
  },
  {
    ...
    "image": "./assets/images/project-56.avif",
  ...
  },
  {
    ...
    image: './assets/images/project-18.avif',
    link: 'https://launchfundr.vercel.app/',
  ...
  },
  {
    ...
    link: 'https://brandingcodemo.vercel.app',
  ...
  },
  {
    ...
    category: 'UI/UX DESIGN',
    tools: 'Figma',
    image: './assets/images/project-17.avif',
  ...
  },
  {
    ...
    tools: 'CorelDRAW',
    image: './assets/images/project-19.avif',
    link: './assets/images/project-19.avif',
  ...
  },
  {
    ...
    category: 'UI/UX DESIGN',
    tools: 'Figma',
    image: './assets/images/project-48.avif',
  ...
  },
  {
    ...
    image: './assets/images/project-33.avif',
    link: './assets/images/project-33.avif',
  ...
  },
  {
    ...
    brief: 'A website redesign proposal for Education Alliance Consulting in Figma, focusing on modern design, improved user experience, and robust prototyping.',
    about: 'This UI/UX project showcases my ability to transform educational organizations\' digital presence through strategic redesigns that balance aesthetics, functionality, and all the other UI/UX essentials like prototyping, reusable components, and micro-interactions.',
    description: 'Led a complete website redesign initiative for Education Alliance Consulting, turning their digital presence into a modern, conversion-focused platform. The project was not just a visual overhaul—it was also well prototyped, with multiple interactive pages covering all key user flows. Built a comprehensive design system with multiple reusable components, sprinkled in micro-interactions for delightful feedback, and made sure the whole thing was accessible (WCAG 2.1 AA). Conducted user research to find pain points and opportunities, then implemented a strategic information architecture that reduced user journey complexity by 60%. The prototype achieved 95% user satisfaction in testing, with big improvements in task completion and engagement.',
    status: 'Completed'
  },
  {
    ...
    link: 'https://hackwithjasper.vercel.app',
  ...
  },
  {
    ...
    link: 'https://resincraft-chi.vercel.app',
  ...
  },
  {
    ...
    category: 'Graphic Design',
    tools: 'CorelDRAW',
    image: './assets/images/project-38.avif',
    link: './assets/images/project-38.avif',
  ...
  },
  {
    ...
    category: 'Graphic Design',
    tools: 'Adobe Photoshop',
    image: './assets/images/project-41.avif',
    link: './assets/images/project-41.avif',
  ...
  },
  {
    ...
    category: 'Graphic Design',
    tools: 'Adobe Illustrator',
    image: './assets/images/project-23.avif',
    link: './assets/images/project-23.avif',
  ...
  },
  {
    ...
    category: 'Graphic Design',
    tools: 'Adobe Photoshop',
    image: './assets/images/project-31.avif',
    link: './assets/images/project-31.avif',
  ...
  },
  {
    ...
    category: 'Graphic Design',
    tools: 'Adobe Photoshop',
    image: './assets/images/project-30.avif',
    link: './assets/images/project-30.avif',
    brief: 'A flyer design for XTM Launch, created using Adobe Photoshop. The design effectively communicates the event message while maintaining visual appeal.',
    about: 'This project highlights my skills in graphic design and visual communication. Through careful attention to typography and layout, I created a flyer design that captures attention and delivers its message effectively.',
  ...
  },
  {
    ...
    category: 'Graphic Design',
    tools: 'Adobe Photoshop',
    image: './assets/images/project-25.avif',
    link: './assets/images/project-25.avif',
    brief: 'A flyer design for XTM Launch, created using Adobe Photoshop. The design effectively communicates the event message while maintaining visual appeal.',
    about: 'This project highlights my skills in graphic design and visual communication. Through careful attention to typography and layout, I created a flyer design that captures attention and delivers its message effectively.',
  ...
  },
  {
    ...
    category: 'Graphic Design',
    tools: 'CorelDRAW',
    image: './assets/images/project-29.avif',
    link: './assets/images/project-29.avif',
  ...
  },
  {
    ...
    category: 'Graphic Design',
    tools: 'Adobe Photoshop',
    image: './assets/images/project-32.avif',
    link: './assets/images/project-32.avif',
    brief: 'A flyer design for XTM Launch, created using Adobe Photoshop. The design effectively communicates the event message while maintaining visual appeal.',
    about: 'This project highlights my skills in graphic design and visual communication. Through careful attention to typography and layout, I created a flyer design that captures attention and delivers its message effectively.',
  ...
  },
  {
    ...
    category: 'Graphic Design',
    tools: 'Canva',
    image: './assets/images/project-34.avif',
    link: './assets/images/project-34.avif',
  ...
  },
  {
    ...
    category: 'Graphic Design',
    tools: 'Adobe Photoshop',
    image: './assets/images/project-20.avif',
    link: './assets/images/project-20.avif',
  ...
  },
  {
    ...
    category: 'Graphic Design',
    tools: 'Adobe Photoshop',
    image: './assets/images/project-22.avif',
    link: './assets/images/project-22.avif',
    brief: 'A flyer design for XTM Launch, created using Adobe Photoshop. The design effectively communicates the event message while maintaining visual appeal.',
    about: 'This project highlights my skills in graphic design and visual communication. Through careful attention to typography and layout, I created a flyer design that captures attention and delivers its message effectively.',
  ...
  },
  {
    ...
    category: 'Graphic Design',
    tools: 'CorelDRAW',
    image: './assets/images/project-24.avif',
    link: './assets/images/project-24.avif',
    brief: 'A flyer design for XTM Launch, created using CorelDRAW. The design effectively communicates the event message while maintaining visual appeal.',
    about: 'This project highlights my skills in graphic design and visual communication. Through careful attention to typography and layout, I created a flyer design that captures attention and delivers its message effectively.',
  ...
  },
  {
    ...
    category: 'Graphic Design',
    tools: 'Canva',
    image: './assets/images/project-37.avif',
    link: './assets/images/project-37.avif',
  ...
  },
  {
    ...
    category: 'Graphic Design',
    tools: 'CorelDRAW',
    image: './assets/images/project-40.avif',
    link: './assets/images/project-40.avif',
  ...
  },
  {
    ...
    category: 'Graphic Design',
    tools: 'Canva',
    image: './assets/images/project-35.avif',
    link: './assets/images/project-35.avif',
    brief: 'A flyer design for XTM Launch, created using Canva. The design effectively communicates the event message while maintaining visual appeal.',
    about: 'This project highlights my skills in graphic design and visual communication. Through careful attention to typography and layout, I created a flyer design that captures attention and delivers its message effectively.',

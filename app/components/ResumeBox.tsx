      ...
      <div data-aos="zoom-in">
        <div className="about-blog-box info-box shadow-box h-full">
          ...
          <div className="resume-icon-wrap">
            <svg xmlns="http://www.w3.org/2000/svg" width="120" height="120" viewBox="0 0 24 24" fill="none" style={{ height: "auto", maxWidth: "100%" }}>
          ...
          <div className="d-flex align-items-center justify-content-between resume-box-info">
            <div className="infos">
              <h4>more about me</h4>
              <h1>Resume</h1>
            </div>

  ...
  return (
    <div data-aos="zoom-in">
      ...
      <div className="about-blog-box info-box shadow-box h-full resume-card">
        ...
        <Image src="/assets/images/bg1.png" alt="" aria-hidden="true" className="bg-img" width={400} height={400} loading="lazy" fetchPriority="low" />
        ...
        <div className="d-flex align-items-center justify-content-between resume-bottom-wrap">
          <div className="infos">
            <h4>more about me</h4>
            <h1>Resume</h1>
          </div>
